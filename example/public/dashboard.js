...
function syncAvailabilityButtons() {
  ...
  whereInput.required = selectedAvailability !== "busy";
  if (whereLabel) {
    whereLabel.textContent = selectedAvailability === "busy" ? "Where (optional)" : "Where";
  }
}
        ...
        isEditing
          ? `
            <form class="event-form edit-form" data-edit-event-form="${selected.id}">
              ...
              <div class="form-grid">
                ...
                <label>
                  <span>Where</span>
                  <input name="where" type="text" value="${escapeHtml(selected.where)}"${selected.availability === "busy" ? "" : " required"} />
                </label>
              </div>
          ...
          : `
            <div class="detail-grid">
              ...
              <div class="detail-card">
                <h3>Where</h3>
                <p>${escapeHtml(selected.where || "No place added yet.")}</p>
              </div>
            </div>
